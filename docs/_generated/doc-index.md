...
| `docs/ecosystem/vibe-lab-productive-role.md` | Labor Productive Role Boundary | active | operative |
...
| `docs/masterplan.md` | Masterplan — Labor Zielbild | active | operative |
| `docs/onboarding/README.md` | Onboarding (Stub-Namespace) | active | navigation |
| `docs/plans/vibe-lab-optimization-plan-v1.md` | Labor Optimization Plan v1 | active | operative |
