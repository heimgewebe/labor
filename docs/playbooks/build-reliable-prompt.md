...
1. Als `prompts/adopted/<name>.md` ablegen; `consumer`, `decision_target` und eine `validated_by`-Relation auf die tragende Evidenz unter `experiments/**/results/` im Frontmatter setzen und im Promotion-PR benennen
