...
| **Prompt**           | PR: `promotion.md`             | `prompts/adopted/`           | Frontmatter: `consumer` + `decision_target` + `validated_by` auf ein `adopted` + `executed|replicated` Experiment mit `adoption_assessment: adopt` |
